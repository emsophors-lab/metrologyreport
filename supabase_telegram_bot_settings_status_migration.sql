...
ALTER TABLE telegram_bot_settings ALTER COLUMN connection_status SET DEFAULT 'not_verified';
ALTER TABLE telegram_bot_settings ALTER COLUMN webhook_status SET DEFAULT 'not_configured';
ALTER TABLE telegram_bot_settings ALTER COLUMN is_active SET DEFAULT false;
